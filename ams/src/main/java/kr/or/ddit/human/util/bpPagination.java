...
public class bpPagination<T> {
	...
	//검색 생성자 시작
	public bpPagination(int total, int currentPage, int size, List<T> content, String keyword) {
	...
	//생성자
	public bpPagination(int total, int currentPage, int size, List<T> content, Map<String,Object> map) {
		//size : 한 화면에 보여질 목록의 행 수
				this.total = total;
				this.currentPage = currentPage;
				this.content = content;
				...
				this.pagingArea += "href='/emp/bpUser/bpList?gubun="+this.gubun+"&keyword="+this.keyword+"&currentPage="+(this.startPage-4)+"'>«</a></li>";
				for(int pNo=this.startPage;pNo<=this.endPage;pNo++) {
					...
					this.pagingArea += "'><a class='page-link' ";
					this.pagingArea += "href='/emp/bpUser/bpList?gubun="+this.gubun+"&keyword="+this.keyword+"&currentPage="+pNo+"'>"+pNo+"</a></li>";
				}//end for
				this.pagingArea += "<li class='page-item";
				...
				this.pagingArea += "'><a class='page-link'";
				this.pagingArea += "href='/emp/bpUser/bpList?gubun="+this.gubun+"&keyword="+this.keyword+"&currentPage="+(this.startPage+5)+"'>»</a></li>"; 
				this.pagingArea += "</ul>";	
	}
