 ...
 * @param <T>
 */
public class VendorListPagination<T> {
	//전체글 수
	private int total;
	//현재 페이지 번호
	...
	//					753				1				10			select결과
	public VendorListPagination(int total, int currentPage, int size, List<T> content
				, String keyword) {
	...
	public VendorListPagination(int total, int currentPage, int size, List<T> content
		...
		this.pagingArea += "href='/emp/inventory/vendorList?searchFilter="+this.searchFilter+"&table_search="+this.table_search+"&currentPage="+(this.startPage-4)+"'>«</a></li>";
		for(int pNo=this.startPage;pNo<=this.endPage;pNo++) {
			...
			this.pagingArea += "'><a class='page-link' ";
			this.pagingArea += " href='/emp/inventory/vendorList?searchFilter="+this.searchFilter+"&table_search="+this.table_search+"&currentPage="+pNo+"'>"+pNo+"</a></li>"; 
		}//end for
		this.pagingArea += "<li class='page-item";
		...
		this.pagingArea += "'><a class='page-link'";
		this.pagingArea += "href='/emp/inventory/vendorList?searchFilter="+this.searchFilter+"&table_search="+this.table_search+"&currentPage="+(this.startPage+5)+"'>»</a></li>"; 
		this.pagingArea += "</ul>";	
	}//생성자 끝
