...
//	private int    amt;
	...
	//					753				1				10			select결과
	public myPaymentPage(int total, int currentPage, int size, List<T> content
				, String keyword) {
...
//		this.amt = Integer.parseInt(map.get("amt").toString());
		...
		this.pagingArea += "href='/elecApv/myPaymentList?gubun="+this.gubun+"&keyword="+this.keyword+"&currentPage="+(this.startPage-4)+"'>«</a></li>";
		for(int pNo=this.startPage;pNo<=this.endPage;pNo++) {
			...
			this.pagingArea += "'><a class='page-link' ";
			this.pagingArea += " href='/elecApv/myPaymentList?gubun="+this.gubun+"&keyword="+this.keyword+"&currentPage="+pNo+"'>"+pNo+"</a></li>"; 
		}//end for
		this.pagingArea += "<li class='page-item";
		...
		this.pagingArea += "'><a class='page-link'";
		this.pagingArea += "href='/elecApv/myPaymentList?gubun="+this.gubun+"&keyword="+this.keyword+"&currentPage="+(this.startPage+5)+"'>»</a></li>"; 
		this.pagingArea += "</ul>";	
	}//생성자 끝
