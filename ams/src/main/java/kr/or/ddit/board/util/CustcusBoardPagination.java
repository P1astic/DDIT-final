...
//페이징 관련 정보 + 게시글 정보
public class CustcusBoardPagination<T> {
	//전체글 수
	private int total;
	//현재 페이지 번호
	...
	//					753				1				10			select결과
	public CustcusBoardPagination(int total, int currentPage, int size, List<T> content
				, String custBrdNm, String phnum) {
		//size : 한 화면에 보여질 목록의 행 수
		this.total = total;
		this.currentPage = currentPage;
		this.content = content;
		this.custBrdNm = custBrdNm;
		this.phnum = phnum;
	...
	public CustcusBoardPagination(int total, int currentPage, int size, List<T> content
		...
		this.custBrdNm = (String) map.get("custBrdNm");
		this.phnum = (String) map.get("phnum");
		...
		this.pagingArea += "href='/cus/list?custBrdNm="+this.custBrdNm+"&phnum="+this.phnum+"&currentPage="+(this.startPage-4)+"'>«</a></li>";
		for(int pNo=this.startPage;pNo<=this.endPage;pNo++) {
			...
			this.pagingArea += "'><a class='page-link' ";
			this.pagingArea += "href='/cus/list?custBrdNm="+this.custBrdNm+"&phnum="+this.phnum+"&currentPage="+pNo+"'>"+pNo+"</a></li>";
		}//end for
		this.pagingArea += "<li class='page-item";
		...
		this.pagingArea += "'><a class='page-link'";
		this.pagingArea += "href='/cus/list?custBrdNm="+this.custBrdNm+"&phnum="+this.phnum+"&currentPage="+(this.startPage+5)+"'>»</a></li>"; 
		this.pagingArea += "</ul>";	
	}//생성자 끝
	...
	public String getCustBrdNm() {
		return custBrdNm;
	}

	public void setCustBrdNm(String custBrdNm) {
		this.custBrdNm = custBrdNm;
	}
	...
	public void setPnum(String phnum) {
		this.phnum = phnum;
	}
