...
$(window).on("load", function(){
    ...
    if (openMenu) {
        ...
        $('#menuC010101').addClass('menu-open');
        $('#menuC010101 > a').addClass('active');
    }
...
<aside class="main-sidebar elevation-4" style="font-family: Pretendard;">
	<div class="_sidebarHead">
	    <a href="/emp/main" class="brand-link _sidebarHeadLink"> 
	        			...
	        			<c:when test="${authMenu.level == 1}">
	        				<li class="nav-item" id="menu${authMenu.mnCd}">
	        					<a href="${authMenu.mnUrl }" class="nav-link">
	        						...
	        						<c:if test="${authMenu.mnCd == 'E040101' || authMenu.mnCd == 'E070101' ||authMenu.mnCd == 'E040401' }">
