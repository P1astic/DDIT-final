...
<nav class="main-header navbar navbar-expand" style="font-family: Pretendard;">
	...
	<ul class="navbar-nav ml-auto align-items-center" style="padding-right:250px;">
		<li class="nav-item">
			<c:if test="${empty memVO.employeeVO.empImgUrl }">
				<img class="profileImg" src="/resources/images/profile.jpg">
			</c:if>
			<c:if test="${!empty memVO.employeeVO.empImgUrl }">
				<img class="profileImg" src="/download?filePath=${memVO.employeeVO.empImgUrl}&fileOrgnlFileNm=${memVO.employeeVO.empImgUrl}">
			</c:if>
		</li>
		<li class="nav-item ml-3">
			${memVO.employeeVO.empNm} 님
		</li>
		<li class="nav-item ml-3">
