...
<script type="text/javascript"
	src="/type/common/js/jquery-2.2.1.min.js?v=1.1"></script>
<script type="text/javascript"
	src="/type/common/js/jquery.easing.1.3.js?v=1.1"></script>
<script type="text/javascript"
	src="/type/common/js/jquery.font-accessibility.dev_bvs.js?v=1.1"></script>
<!-- 폰트줌(제한) -->
...
<link rel="stylesheet" type="text/css"
	href="/type/common/js/slick/slick.css?v=1.1" />
<!-- 슬라이더 -->
<script type="text/javascript"
	src="/type/common/js/slick/slick.min.js?v=1.1"></script>
<!-- 슬라이더 -->
<script type="text/javascript"
	src="/type/common/js/slick/slick.acc.js?v=1.1"></script>
<!-- 슬라이더 -->

<link rel="stylesheet" type="text/css"
	href="/type/common/js/mCustomScrollbar/jquery.mCustomScrollbar.css?v=1.1" />
<!-- 커스텀스크롤 -->
<script type="text/javascript"
	src="/type/common/js/mCustomScrollbar/jquery.mCustomScrollbar.concat.min.js?v=1.1"></script>
<!-- 커스텀스크롤 -->
...
<script>
	$().ready(
			function() {
				...
				//mailto 처리
				var mailtoSubject = $("meta[property='og:title']").attr(
						"content");
				var mailtoBody = mailtoSubject + "\n\n" + fn_getUrl();
				$("#mailShare").attr(
						"href",
						'mailto:?subject=' + encodeURIComponent(mailtoSubject)
...
<div id="contents">
	...
	<div id="contTabFix">
		<ul class="tabList tab02">
			...
			<li><a href="/cust/map/howCheck" title="선택됨" class="on"
				id="title">국내선</a></li>




			<li><a href="/cust/map/howW" id="world">국제선</a></li>
			...
			<div class="slide-UpDown2" data-slide="listBtn2">
				<ul>
						...
						<div class="list-dtl">
							<div class="txtGroup">
								<div class="TxtG-inner-1">
									...
									<p class="subTxt1 sDot">
										...
										세로40cm,<br />높이20cm(총합 115cm 이내), 무게 10kg 이내의 물품에 대해서만 반입이
										허용됩니다.
									</p>
								...
								<div class="TxtG-inner-1">
									...
									<div class="link-group">
										<a
											href="https://www.airport.co.kr/gimpo/cms/frCon/index.do?MENU_ID=1130&CONTENTS_NO=6"
							...
							<div class="txtGroup">
								<div class="TxtG-inner-1">
									...
									<p class="subTxt1 sDot">
										안전한 여행을 위해 개인 짐은 되도록 간편하게 꾸립니다. 특히, 항공기 객실에서는 선반에 들어갈 수 있는 작은
										가방 1개 정도만 휴대하십시오. 만약을 대비해 가방의 <br />안쪽과 바깥쪽에 고객님의 이름과 주소지 그리고
										목적지가 잘 보일 수 있도록 영문으로 작성한 이름표를 붙여두십시오.
									</p>
									<p class="subTxt1 sDot">
										노트북 컴퓨터, 캠코더, 카메라, 보석류, 골동품, 귀금속류 등 고가의 물품은 짐에 넣지 마시고 직접 휴대하시기
										바랍니다. 이러한 물품 또는 현금, 유가증권, 계약서류 <br />논문, 의약품 등의 분실이나 그대로 인한
										손해에 대해 공항당국 및 항공사에서는 책임을 지지 않습니다.
									</p>
									<p class="subTxt1 sDot">
										수하물은 항공사마다 그 크기나 무게에 관한 기준이 다르기 때문에 반드시 항공사에서 안내하는 지정된 크기와 무게를
										초과하지 않도록 해주시고, 내용품이 <br />손상되지 않도록 적절히 포장하시기 바랍니다. 자전거, 서핑보드와
										같은 스포츠 용품 등 특수물품이나 애완동물은 사전에 반드시 항공사에 알려주시고 출발 당일 <br />여유있게
										처리하십시오.
									</p>
									<p class="subTxt1 sDot">일반적으로 미주 지역은 개수가 기준이 되며 동남아, 유럽 등
										미주 이외의 지역은 무게를 기준으로 합니다. 고객님의 여행 구간과 탑승 클래스를 확안히시기 바랍니다.</p>
								</div>
							</div>
							<div class="txtGroup">
								<div class="TxtG-inner-1">
					...
					<li><button type="button" title="상세내용 열기">
							...
							<p class="subTit3">탑승장 신원확인 및 항공권 검사</p>
						</button>
						<div class="list-dtl">
							<div class="txtGroup">
								<div class="TxtG-inner-1">
									<p class="subTxt1 sDot">항공기 탑승객은 국내선을 이용하기 위해 신분증 및 항공권을
										준비해야 합니다.</p>
									<p class="subTxt1 sDot">출발장 입구에서 경비요원(청원경찰)에게 신분증(주민등록증,
										운전면허증, 여권 등) 및 항공권을 제시하여 신원을 확인받습니다.</p>
								</div>
							</div>
						</div></li>
					<li><button type="button" title="상세내용 열기">
							...
							<div class="txtGroup">
								<div class="TxtG-inner-1">
									...
									<p class="subTxt1 sDot Name" data-cont="STEP 4">
										X-ray 검색이 완료되면 본인의 소지품을 모두 챙겨 탑승구로 이동합니다.<br />기내 반입금지 물품 확인을
										위해 추가로 검색을 받으실 수 있으니, 검색원의 안내에 협조하여 주시기 바랍니다.
									</p>
					...
					<li><button type="button" class="noArr" title="상세내용 없음">
							...
							<p class="subTit3">탑승게이트 대기 및 항공기 탑승</p>
						</button></li>
				</ul>
			</div>
			<script>
