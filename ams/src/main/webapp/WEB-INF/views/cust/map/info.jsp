...
<link rel="stylesheet"
	href="//t1.daumcdn.net/kakaomapweb/map/202410071046131/app_A.css">
<link rel="stylesheet"
	href="//t1.daumcdn.net/kakaomapweb/map/202410071046131/app_B.css">
<link rel="stylesheet"
	href="//t1.daumcdn.net/kakaomapweb/map/202410071046131/app_C.css">
<link rel="stylesheet"
	href="//t1.daumcdn.net/kakaomapweb/map/202410071046131/app_D.css">
<link rel="stylesheet"
	href="//t1.daumcdn.net/kakaomapweb/map/202410071046131/canvas_roadview.css">

<link rel="stylesheet"
	href="https://t1.daumcdn.net/kakaomapweb/subway/linemap/svg/prod/resources/style.css">
...
<link rel="search" type="application/opensearchdescription+xml"
	...
	<div id="info" class="Info">
				...
				<div class="favorite_interlock HIDDEN">
					...
					<div id="my.static" class="favorite_homecorp HIDDEN">
						...
						<div class="group_tit">
							...
							<span class="info_count"> ( <span class="num_count"
								data-id="spotTotalCount"></span> / <span class="num_total">5</span>
								)
							</span>
						</div>
		...
		<div id="footer" class="Footer">
			<a class="xa" target="_blank"
				href="https://cs.kakao.com/helps?locale=ko&service=101">고객센터</a> <a
				class="xc" href="#none" data-pos="footer"
				data-channel="SEARCH_BOTTOM_NEWPLACE">신규 장소 등록</a> <a
				target="_blank"
				href="https://www.kakao.com/policy/privacy?type=p&lang=ko"><strong>개인정보처리방침</strong></a>
		</div>
	</div>
	...
	<div id="view" class="View">
		...
		<div id="view.map" class="map map-skyview">
			<div id="localInfo" class="LocalInfo HIDDEN">
				<div id="localInfo.map" class="localinfomap">
					...
					<div id="localInfo.map.weather" class="tempInfo">
						<div class="center">
							<img id="localInfo.map.weatherIcon" class="weatherImg HIDDEN"
								alt="" src="//t1.daumcdn.net/mapjsapi/images/transparent.gif" />
			...
			<form name="subway_scrap_form" method="post"
				...
				<input type="hidden" name="cityCode" value="" /> <input
					type="hidden" name="STARTNAME" value="" /> <input type="hidden"
					name="ENDNAME" value="" /> <input type="hidden" name="STARTID"
					value="" /> <input type="hidden" name="ENDID" value="" />
			</form>
			...
			<form name="subway_print_form" method="post"
				...
				<input type="hidden" name="cityCode" value="" /> <input
					...
					value="" /> <input type="hidden" name="routeMapImageData" value="">
			</form>
			...
			<form id="scrap_form" name="scrap_form" method="post"
				...
				<input type="hidden" name="x" value="" /> <input type="hidden"
					name="y" value="" /> <input type="hidden" name="scale" value="" />
			...
			<div id="miniZoomControl"
				...
				<div class="wrap_zoom">
					<a href="#none" id="miniZoomControl.zoomin" class="zoomin"><span
						class="ico_roadview2 ico_zoom">확대</span></a> <a href="#none"
						id="miniZoomControl.zoomout" class="zoomout"><span
						class="ico_roadview2 ico_zoom">축소</span></a>
				</div>
			</div>
		...
		<div id="view.subway" class="subway">
			...
			<div id="view.subway.route" class="subwayRouteView">
				<div id="kakaoSubway"></div>
			</div>

			<div id="subwayLegend.zoom" class="subwayLegendZoom">
				<div class="bar_range">
					<input type="range" id="inpRange" name="inpRange" min="1" max="8"
						value="1" class="inp_range"> <label for="inpRange"
						class="screen_out">8단계</label>
				</div>
	...
	<script type="text/javascript"
		src="//t1.daumcdn.net/kakaomapweb/cssjs/sentry.min.5.27.4.js"
		crossorigin="anonymous"></script>
	<script type="text/javascript"
		src="//t1.daumcdn.net/cssjs/JSON-js/fc535e9cc8/json2.min.js"></script>
	<script type="text/javascript"
		src="//t1.daumcdn.net/tiara/js/v1/tiara.min.js"></script>

	<!--[if gt IE 8]><!-->
	<script type="text/javascript"
		src="//t1.daumcdn.net/cssjs/mapweb/1500538479259/Chart.min.js"></script>
	<script type="text/javascript"
		src="//t1.daumcdn.net/kakaomapweb/cssjs/hls-0.12.4.min.js"></script>
	<!--<![endif]-->

	<script type="text/javascript"
		src="//mk.kakaocdn.net/dn/platformfe/agent/v2_2_0/agent.js"></script>

	<script type="text/javascript"
		src="//t1.daumcdn.net/daumtop_deco/socialshare/socialshare_pc-2.5.1.js"></script>

	<script type="text/javascript"
		src="//t1.daumcdn.net/kakaomapweb/resource/require-2.1.0.js"></script>
	<script type="text/javascript"
		src="//t1.daumcdn.net/cssjs/jquery/jquery-1.8.1.min.js"></script>
	<script type="text/javascript"
		src="//t1.daumcdn.net/cssjs/jquery/plugin/jquery.cookie-1.0.0.min.js"></script>
	<script type="text/javascript"
		src="https://ssl.daumcdn.net/dmaps/map_js_init/v3.js"></script>
	<script type="text/javascript"
		src="//t1.daumcdn.net/mapjsapi/js/libs/congnamul.js"></script>
	<script type="text/javascript" src="./iptargeting/location"></script>

	<script>
		var envDsn = 'https://' + '9f8781b9c86f4e7bbfae4bce5e29cfcc'
				+ '@aem-kakao-collector.onkakao.net/' + '5640';
							...
							.init(
									{
										svcDomain : window.location.host
												...
												: 'map.devel.kakao.com',
										deployment : window.ENV === 'PROD' ? 'production'
												: 'dev'
									});
		} catch (e) {
		}
	...
	<script>
		// 지하철 노선도 초기화
		window.kakaoSubway = null;
	</script>
	<script type="text/javascript"
		src="https://t1.daumcdn.net/kakaomapweb/subway/linemap/svg/prod/resources/kakao-subway.js"></script>
	...
	<script type="text/javascript"
		src="//t1.daumcdn.net/kakaomapweb/map/202410071046131/app.js"></script>
					...
					config : {
						main:{
							...
							options : {
								...
								gasPrice : {
									avgGasPrice : 1591.447,
									avgDieselPrice : 1421.5582,
									avgLpgPrice : 1016.363,
									gasDate : "2024-10-14",
									dieselDate : "2024-10-14",
									lpgDate : "2024-10-14"
								},
								notice_popup : "N",
								event_notice : "N",
