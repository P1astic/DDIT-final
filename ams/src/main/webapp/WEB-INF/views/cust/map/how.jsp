...
<link rel="stylesheet" type="text/css"
	href="/resources/css/custUser/how.css">
		...
		<ul>
				...
				<div class="list-dtl">
					<div class="txtGroup">
						<div class="TxtG-inner-1">
							...
							<p class="subTxt1 sDot">항공안전 및 보안에 위협이 될 수 있는 물품은 위탁수하물에 넣으면
								안됩니다. 아래 운송 제한 품목을 참고해주시기 바랍니다.</p>
						</div>
						<div class="TxtG-inner-1">
					...
					<div class="txtGroup">
						<div class="TxtG-inner-1">
							...
							<p class="subTxt1 sDot">
								안전한 여행을 위해 개인 짐은 되도록 간편하게 꾸립니다. 특히, 항공기 객실에서는 선반에 들어갈 수 있는 작은 가방
								1개 정도만 휴대하십시오. 만약을 대비해 가방의 <br>안쪽과 바깥쪽에 고객님의 이름과 주소지 그리고
							...
							<p class="subTxt1 sDot">일반적으로 미주 지역은 개수가 기준이 되며 동남아, 유럽 등 미주
								이외의 지역은 무게를 기준으로 합니다. 고객님의 여행 구간과 탑승 클래스를 확안히시기 바랍니다.</p>
						</div>
					</div>
					<div class="txtGroup">
						<div class="TxtG-inner-1">
							<p class="subTit4">객실로 가져갈 수 없는 운송 제한 품목</p>
							<p class="subTxt1">다용도 칼(일명 맥가이버칼), 커터칼, 가위, 과도, 골프채 등은 객실반입이
								금지되어 있어 체크인할 때 위탁수하물로 처리해주시기 바랍니다.</p>
						</div>
					</div>
					<div class="txtGroup">
						<div class="TxtG-inner-1">
			...
			<li><button type="button" title="상세내용 열기">
				...
				<div class="list-dtl">
					<div class="txtGroup">
						<div class="TxtG-inner-1">
							<p class="subTxt1 sDot">항공기 탑승객은 국내선을 이용하기 위해 신분증 및 항공권을 준비해야
								합니다.</p>
				...
				<div class="list-dtl">
					<div class="txtGroup">
						<div class="TxtG-inner-1">
							...
							<p class="subTxt1 sDot Name" data-cont="STEP 1">검색이 원활히 진행될 수
								있도록 대기하시는 동안 가방과 자켓 등을 미리 벗어주세요.</p>
							<p class="subTxt1 sDot Name" data-cont="STEP 2">휴대물품(가방, 핸드백,
								자켓 등)을 포함한 모든 소지품(휴대폰, 지갑, 동전, 열쇠 등)을 바구니에 담아주세요.</p>
							...
							<div class="link-group mbt">
								<a href="https://www.avsec365.or.kr" target="_blank"
									title="새창이동" class="sbtn-mid LinkArrow"><span>항공기 내
										반입금지 위해물품 확인하기</span></a>
							</div>
						</div>
					</div>
				</div></li>
		...
		$("[data-slide=listBtn2] button").on(
				...
				function(e) {
					if (!$(this).hasClass("noArr")) {
						$(this).not(".noArr").toggleClass("on").parent("li")
								.find(".list-dtl").slideToggle(300);
