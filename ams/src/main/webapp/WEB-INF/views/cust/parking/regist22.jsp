				...
				<div class="inner">
					...
					<div id="subCont">
						...
						<div class="section">
							...
							<div class="table type01 web">
								<table>
									...
									<tbody>
										<tr>
											<th scope="row">예상 주차요금<br />
											<span class="colorType red boldFont">(출차 시 결제)</span></th>
											<td><p name="ccAmt" />원</td>
											<th scope="row">예약 보증금</br>
											<span class="colorType red boldFont">(선결제 필요)</span></th>
						...
						<div class="section">
							...
							<div class="txtInfo">
								<div class="txtBox reserve" title="주차예약 이용안내 내용" tabindex="0">
									<div class="termsBox">
										[전국공항 주차장 예약서비스 이용약관]<br>
										<br> 제1장 총칙<br> 제1조(목적) 이 약관은 한국공항공사(이하 ‘공사’라 한다)가
										관리・운영하는 공항 예약 주차장에서 공사와 주차장 예약 서비스 이용자 사이의 권리와 의무, 책임・준수사항 등을
										정하는 것을 목적으로 한다. <br>
										<br> 제2조(정의) 이 약관에서 사용하는 용어의 정의는 다음 각 호와 같다. <br> 1.
										“주차장”이란 공사가 직접 또는 위탁용역으로 관리・운영하는 주차장을 말한다. <br> 2. “예약
										주차장”이란 공항 주차장 중 예약하여 이용할 수 있는 주차장을 말한다. <br> 3. “주차장
										예약서비스”란 인터넷을 통해 공항 예약 주차장 내 주차공간을 미리 예약하는 서비스를 말한다. <br>
										4. “이용자”라고 함은 본 약관에 동의하고 공사가 제공하는 주차장의 예약서비스를 이용하는 자를 말한다. <br>
										5. “예약부도”란 예약을 해놓고 아무런 연락 없이 나타나지 않는 것을 말한다. <br>
										<br> 제3조(적용 등)<br> ① 이 약관은 공사가 제공하는 주차장 예약 서비스 및 이에
										부대하는 모든 업무에 적용한다. <br> ② 이 약관에서 정하지 않은 사항은 법령 또는 공사
										주차장관리운영예규를 적용한다.<br>
										<br> 제4조(약관의 변경)<br> ① 공사는 적용법령의 개정, 정부의 명령・지시 또는
										공사가 필요한 경우에는 이 약관을 변경 할 수 있다. <br> ② 제1항에 따라 약관을 변경한 경우
										공사는 인터넷 홈페이지 등에 변경사항을 게시한다. 이 때 이용자의 명시적인 이의가 없는 경우 이용자는 변경된
										약관에 동의하는 것으로 간주한다.<br> 제5조(이용자 정보 사용에 대한 동의) ① 이용자의 개인정보는
										개인정보보호법에 의하여 보호된다.<br> ② 공사는 주차장 예약서비스 제공과 관련해서 수집한 이용자의
										정보를 본인의 승낙 없이 제3자에게 누설, 배포하지 않는다. 단, 법률의 규정에 의하여 적법한 절차에 따라
										요청이 있는 경우는 예외로 한다.<br>
										<br>
									</div>
									<div class="termsBox">
										제2장 주차장 예약서비스 이용계약<br>
										<br> 제6조(주차장 예약서비스 이용계약의 성립) <br> ① 본 약관에 따른 이용계약은
										이용자가 본 약관에 대한 동의와 함께 서비스에 대한 이용신청을 하고 예약이 확정됨으로써 성립한다.<br>
										② 예약 주차장을 이용하고자 할 경우 온라인(인터넷 홈페이지, 웹, 모바일 앱)으로 접수 신청을 하여야 한다.
										<br> ③ 주차장 예약은 예약신청 시점부터 45일 후까지로 예약일을 지정할 수 있고, 최소 2시간부터
										최대 30일까지 예약할 수 있다.<br> ④ 이용자는 여러 대의 차량을 예약 신청하거나, 동일 차량에
										대하여 여러 차례 예약 신청할 수 있다. 단, 동일 차량을 여러 차례 예약 신청하는 경우 일정이 중복되도록
										예약하는 것은 불가하다.<br>
										<br> 제7조(예약 확인)<br> ① 예약번호는 예약 접수 완료 시 생성되며 공사는
										이용자에게 SMS 또는 E-mail 등을 통하여 예약내역을 통지한다. <br> ② 예약접수 이후 예약을
										확인하고자 하는 경우에는 예약번호, 차량번호, 이메일 중 한 가지를 기재하고, 이후 예약 시 입력하였던
										휴대전화번호 및 비밀번호도 함께 기재하여야 한다.<br>
										<br> 제8조(예약 변경)<br> ① 이용자는 다음 각 호에 해당하는 경우 예약의 변경
										신청을 할 수 있다. <br> 1. 입차 예정시간 1시간 전까지 신청하는 경우<br> 2.
										입차 예정시간 전 1시간 이내에 예약한 경우에는 예약 신청시간으로부터 20분 이내 신청하는 경우 <br>
										② 고객의 이용 희망일 예약 주차장 잔여면 수가 충분하지 않을 경우(이하 “만차”이라 한다) 예약의 변경이
										불가능 할 수 있다. <br>
										<br> 제9조(예약 주차장 이용 및 입차 제한) <br> ① 입차는 예약 입차시간 기준
										2시간 전부터 2시간 후까지 가능하다.<br> ② 이용자는 다음 절차에 따라 공사 직원의 지시를
										준수하며 예약 주차 공간을 이용 하여야 한다.<br> 1. 예약된 입차 시간까지 예약 주차장 입구에
										도착<br> 2. 예약 주차 입구로 진입하여 차량번호 인식 후 입차<br> 3. 예약 주차장
										내 비어 있는 주차면에 주차<br> 4. 출차 시, 예약 주차장 출구를 통해 출차<br> ③
										장애인 차량의 경우 장애인 전용 주차면을 예약하고 이용할 수 있다. 단, 장애인 자동차 표지가 부착된 자동차에
										보행상 장애가 있는 자가 탑승한 경우에만 주차할 수 있고, 이를 위반한 자가 이용하는 경우에는 관련법에 따라
										과태료를 부과 받을 수 있다.<br> ④ 공사는 다음 각 호의 사유가 있는 경우 예약서비스 이용자의
										입차를 제한할 수 있다.<br> 1. 예약 주차장의 주차단위구획(주차빌딩 등인 경우 높이 포함)을
										벗어나는 차량<br> 2. 위험물을 적재하였거나 악취를 현저하게 발생시키는 차량<br> 3.
										자동차의 구조상 주차가 불가능하거나 곤란한 경우<br> 4. 주차장 설비 및 다른 차량을 손상할 우려가
										있는 차량<br> 5. 주차장 내에서 공사의 승인을 받지 않은 영업행위를 하는 차량<br>
										6. 이륜자동차<br> 7. 기타 주차장 관리에 지장이 있는 차량이 주차하려고 할 때<br>
										<br>
									</div>
									<div class="termsBox">
										...
										주차장관리운영예규 제8조를 준용하여 적용한다. <br>
										<br> 제11조 (주차요금 정산) ① 예약 주차장을 이용한 차량은 주차장 출차 시, 예약 주차장
										출구를 통해 출차하며, 예약 보증금으로 선 정산되며 추가 정산이 필요한 차량은 사전 무인정산기 또는 주차장 출구
										등에서 정산 후 출차한다. <br> ② 주차요금은 입차시간 및 출차시간을 기준으로 정산하는 것을
										원칙으로 한다. <br>
										<br> 제12조 (예약부도 패널티)<br> ① 입차 예정시간 2시간이 경과하는 때까지
										입차하지 아니하는 경우 예약부도(No-show)로 간주한다. <br> ② 예약부도시 위약금은 예약
										보증금의 100%로 한다.<br> ③ 예약일 기준 1년간 2회 이상 예약부도 시 예약 출차일로부터
										3개월 동안 공항 주차 예약서비스를 이용할 수 없다. <br>
										<br> 제13조 (예약 취소 및 환불 처리)<br> ① 제8조 제1항 각 호에 해당하여
										예약을 취소하는 경우 전액 환불이 가능하나, 제8조 제1항 각 호에서 규정한 시간보다 임박하여 예약을 취소하는
										경우 위약금 공제 후 환불이 가능하다. 구체적인 산정방법은 아래와 같다.<br> 1. 예약시점 ∼ 입차
										예정시간 1시간 전까지 : 전액 환불<br> 2. 입차 예정시간 1시간 전 ∼ 입차 예정시간 2시간
										경과까지 : 예약 보증금 50% 환불 (50% 위약금)<br> 3. 입차 예정시간 2시간
										이후(예약부도) ∼ : 환불 불가<br> 4. 입차 예정시간 1시간 전 구매 후 20분 이내 취소 시
										: 전액 환불<br> ② 공사는 환불 처리 시 이용자의 성명, 연락처, 환불적용계좌, 환불금액,
										환불사유 확인을 추가로 요구 할 수 있다.<br> ③ 공항의 책임으로 인한 예약취소는 수수료 없이 전액
										환불이 원칙이나 아래와 같은 사유로 인한 예약취소는 환불에서 제외된다.<br> 1. 전쟁이나 전쟁의
										위협, 폭동, 내란, 테러<br> 2. 자연·방사능 재난, 화재, 노동쟁의, 악천후, 화산폭발 또는
										화산재<br> 3. 정부규제, 항공 스케쥴의 변경 또는 취소<br>
										<br>
									</div>
									<div class="termsBox">
										...
										③ 기타 관리자가 본 서비스 이용자로서 부적합하다고 판단하는 경우<br>
										<br> 제16조(공사의 책임 및 면책사항)<br> ① 공사는 이용자가 본 서비스를 안정적으로
										이용 할 수 있도록 서비스를 운영하여야 하며 서비스용 설비에 장애가 발생하는 경우 그 설비를 수리하거나 복구할
										의무가 있다. ② 제1항에도 불구하고, 공사는 다음 각 호의 책임이 면제된다.<br> 1. 서비스
										장애가 발생하여 예약서비스가 제한되거나 일시적으로 중단, 지연되는 경우의 책임<br> 2. 이용자의
										귀책사유로 발생하는 손해에 대한 책임<br> 3. 이용자가 등록한 정보가 설비 고장 등으로 인해
										멸실됨에 따라 이용자에게 생긴 손해에 대한 책임<br> 4. 이용자가 서비스 이용과 관련하여 이용자간에
										발생한 손해 중 이용자의 고의, 과실에 의한 손해 및 타 이용자로 인하여 입게 되는 피해에 대하여 보상할 책임<br>
										<br>
									</div>
									<div class="termsBox">
										제5장 기타<br> 제17조(관할법원) 서비스 이용으로 발생한 분쟁에 대한 소송은 공사 본사 소재지를
										관할하는 법원을 관할법원으로 한다.<br>
										<br> 부칙 <2022. 9. 20><br>
						...
						<div class="section">
							...
							<p class="">
								한국공항공사는 주차예약 서비스 제공을 위해 아래와 같이 개인정보를 수집·이용·제공하고 있습니다.<br />
								<br /> □ 개인정보의 수집·이용에 관한 사항 (필수)
							</p>
							<!--txtInfo-->
							<div class="txtInfo">
