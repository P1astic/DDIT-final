<%@ page language="java" contentType="text/html; charset=UTF-8"
  ...
  <head>
    ...
    <link rel="stylesheet" type="text/css" href="/resources/css/parking/style.css">
...
<!--       </div> -->
      <div class="p-grid" style="margin-top: 30px">
        <button class="button p-grid-col5" onclick="localhost/cust/parking/registInfo';">완료</button>
