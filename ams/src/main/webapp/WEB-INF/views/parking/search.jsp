...
<!-- 	</header> -->
	...
	function pop_up(url){
		...
		<form id="reservationVO" name="reservationVO"
			action="/reservation/resView.do" method="post">
			<input type="hidden" id="reservationNo" name="reservationNo" /> <input
				type="hidden" id="reservationId" name="reservationId" /> <input
				type="hidden" id="encryptId" name="encryptId" /> <input
				type="hidden" id="carNo" name="carNo" /> <input type="hidden"
				id="resInDttm" name="resInDttm" /> <input type="hidden"
				id="regDttm" name="regDttm" /> <input type="hidden" id="status"
				name="status" /> <input id="preReservationYn"
				name="preReservationYn" type="hidden" value="" />
			<div id="content">
				<div class="inner">
					<!--location-->
						...
						<div class="section">
									...
									<tbody>
											...
											<td>
												<div class="flex radioRow">
													<div class="radioGroup">
														<div class="radio">
															<input id="radio01" name="certWay" checked="checked"
																type="radio" value="1" /> <label for="radio01">차량번호</label>
														</div>
														<div class="radio">
													...
													<div class="flex ml50 discountAmtCalDiv">
														<input id="certValue" name="certValue" title="인증방법 선택"
															placeholder="인증방법 선택 후 입력해주세요." type="text"
															class="colorType w728 valid" value="" />
													</div>
												</div>
											</td>
										</tr>
										<tr>
											<th scope="row"><label for="mobile">휴대폰번호<span
										...
										<tr>
											...
											<td><input id="password" name="password" title="비밀번호 입력"
												placeholder="예약신청 시 입력했던 비밀번호를 입력해주세요." type="password"
												class="valid" value="" /></td>
										</tr>
										<tr>
											<th scope="row"><label for="passwordCk">비밀번호 확인<span
													class="redDot" title="필수입력">*</span></label></th>
											<td><input type="password" id="passwordCk" class=""
												title="비밀번호 재입력" placeholder="예약신청 시 입력했던 비밀번호를 다시 입력해주세요." />
											</td>
										</tr>
									</tbody>
								</table>
							...
							<div class="btnArea flex txt-center mt40">
								<button type="button" class="button white"
									onclick="goPasswordfindView(); return false;" id="">비밀번호찾기</button>
								<button type="button" class="button dkBlue"
									onclick="resViewBtn();"
									onkeypress="if(event.keyCode==13){resViewBtn(); return false;}">
									예약</br>조회/변경/취소
								</button>
							</div>
							<!--//btnArea-->
							...
							<p class="colorType green">
								*예약 세부내역 <span class="colorType red boldFont">조회/변경/취소</span>는
								아래 표의 <span class="colorType red boldFont">세부사항을 클릭</span>하여 주시기
								바랍니다.
							</p>
...
$(function() {
	...
	<div class="modal fade findPassword" id="findPassword" tabindex="-1"
		role="dialog" aria-labelledby="findPassword" aria-hidden="true"
		style="z-index: 1070">
		<div class="popup">
			<!--popupPd-->
			<div class="popupPd">
				...
				<div class="popCont">
									...
									<tr>
										<td>
											<div class="flex tell">
												...
												</select> <input type="text" id="empMobile2" title="휴대폰번호 중간자리 입력"
													placeholder="1234" minlength="4" maxlength="4"> <input
													type="text" id="empMobile3" title="휴대폰번호 끝자리 입력"
													placeholder="5678" minlength="4" maxlength="4">
										...
										<td>
											<div class="flex">
												<div class="inputWrap">
													...
													<span class="time"><i class="ico"></i><span
														id="timer" /></span>
												</div>
												<button type="button" class="button white"
													onclick="timeExtensionBtn()">시간연장</button>
											</div>
										</td>
									</tr>
								</tbody>
								...
								<tbody>
									...
									<tr>
										<td><input type="password" id="newPassword"
											title="변경할 비밀번호 입력" placeholder="변경하실 비밀번호를 입력해주세요."></td>
									</tr>
									<tr>
										<th scope="col"><label for="newPasswordCk">비밀번호
												확인</label></th>
									</tr>
									<tr>
										<td><input type="password" id="newPasswordCk"
											title="변경할 비밀번호 재입력" placeholder="변경하실 비밀번호를 다시 입력해주세요."></td>
									</tr>
								</tbody>
							</table>
						</div>
					...
					<div id="msg" class="skyBox changePwBtn">휴대폰번호 입력 후 인증을
						완료해주세요.</div>
					<!--btnArea-->
					<div class="btnArea flex txt-center certifyArea">
						<button type="button" class="button gray cancel" id="cancel">취소</button>
						<button type="button"
							class="button dkBlue w138 notuse certification"
							disabled="disabled" id="next">다음</button>
					</div>
					<div class="btnArea flex txt-center findPwArea"
						style="display: none;">
						<button type="button" class="button gray" id="prev">이전</button>
						<!--############### 비밀번호 변경 ###############-->
						<button type="button" class="button dkBlue w138" id="targetBtn">비밀번호
							변경</button>
						<!--############### 비밀번호 초기화 ###############-->
