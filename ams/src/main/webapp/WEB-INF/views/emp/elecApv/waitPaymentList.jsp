...
$(document).ready(function(){
		...
		<div id="title-box">
			...
			<div class="title-txt">-</div>
			<div class="title-txt" style="color: rgba(0, 0, 0, 0.88);">결재 대기문서</div>
	</div>
		...
		<table class="table table-hover text-nowrap">
			...
			<tbody>
			 <c:forEach var="elecApvVO" items="${elecApvVOList}" varStatus="stat">
				<c:if test="${!memVO.memId.equals(elecApvVO.memId) && fn:contains(elecApvVO.apvDetailVO.apvIds, memVO.memId) && elecApvVO.elecApvStat.equals('H1')}">
