				...
				<form name="registForm" id="registForm">
	                <div class="card-body">                
	                	...
	                	<div class="form-group">
							...
							<select class="selBox" required name="ntcBrdType" id="ntcBrdType">
								<option value="" selected disabled>선택</option>
								<c:forEach var="commonCodeDetailVO" items="${noticeType}" varStatus="stat">
			            ...
			            <div class="regist-footer">
							...
							<a href="/emp/board/list" class="btn btn-secondary" id="listBtn" >목록</a>                
						</div>
