				...
				<form name="editForm" id="editForm">
					<div class="card-body">
						<input type="hidden" id="memId" name="memId"
							value="${boardVO.memId}"> <input type='hidden'
							id="ntcBrdNo" name="ntcBrdNo" value="${boardVO.ntcBrdNo}">
						...
						<div class="form-group">
							<label for="ntcBrdTtl">제목</label> <input type="text"
								class="form-control" id="ntcBrdTtl" name="ntcBrdTtl"
								value="${boardVO.ntcBrdTtl}" required>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="input-group">
								<div class="custom-file">
									<label id="uploadFileBtn" for="uploadFile">선택</label> <input
									...
									<c:if test="${boardVO.fileGroupNo > 0}">
										...
										<c:forEach var="fileDetailVO" items="${fileDetailVOList}"
											...
											<div class="files" id="fileNum${status.index}">
												...
												<button class="fileDel" data-index="${status.index}"
													type="button">
													<img src="/resources/images/icon/trashcan.png">
												</button>
											</div>
